static char xxxvers[ ] = "\nEFL VERSION 1.13,  28 April 1980";
...
/* Flags:
	...
	-g	output for GCOS (ASCII) (default)
	-G	output for GCOS (BCD)
	-u	output for Unix
...
ptr thisexec;
ptr thisctl;
ptr tempvarlist	= NULL;
ptr temptypelist	= NULL;
ptr hidlist	= NULL;
ptr commonlist	= NULL;
ptr gonelist	= NULL;
int blklevel	= 0;
...
int ftnmask[NFTNTYPES] 	= { 1, 2, 4, 8, 16 };
