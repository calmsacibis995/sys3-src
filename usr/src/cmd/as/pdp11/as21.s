...
aexit:
	...
	mov	a.tmp3,0f
	sys	unlink; 0:..
				/ Find out what the umask is (was)
	sys	umask ; 0	/   by setting an arbitrary one
				/   (no harm because we're exiting anyway)
	bic	r0,outmod	/ Change result mode appropriately
