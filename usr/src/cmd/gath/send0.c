...
char *
send0() {return ("~|^`send0.c 1.5 8/22/78");};

int nhst = -1;

struct hsts host[] = {1,"C",1,"B",1,"A",2,"U1",2,"U2",2,"U3",4,"sig5",4,"NLSC"};
int NHST = (sizeof(host)/sizeof(host[0]));
...
char rtr[256] = {	/*	Conversion tables for EBCDIC to 8-bit ASCII	*/
